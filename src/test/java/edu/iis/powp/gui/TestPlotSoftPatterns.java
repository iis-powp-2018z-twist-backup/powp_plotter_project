...
public class TestPlotSoftPatterns {
	...
	private static void setupPresetTests(Application application) {
		...
		SelectTestFigureOptionListener2 selectTestFigureOptionListener2 = new SelectTestFigureOptionListener2(null);
	...
	private static void setupDrivers(Application application) {
		...
		application.addDriver("Line Plotter", linePlotter);
